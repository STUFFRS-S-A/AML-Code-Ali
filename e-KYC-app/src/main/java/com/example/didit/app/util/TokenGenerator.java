...
public class TokenGenerator {
    ...
    public static String buildAuthToken(String requestId, String requestDate, String requestTime) throws Exception {
    ...
    public static int AESEncryptText(String key, String data, StringBuilder eData, StringBuilder errDesc) {
        try {
